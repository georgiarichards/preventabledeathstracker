...
const summary_headers = {
  ...
  'Category:?': 'category',
  'This death is being sent to:?|This report is sent to:?|This report is being sent to:?|These reports are being sent to:?|This is being sent to:?|This has been sent to:?|These reports have been sent to:?|The report is being sent to:?|This response is being sent to:?|This report was being sent to:?': 'this_report_is_being_sent_to'
}
